...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WallComment.commenter'
        db.add_column('wall_wallcomment', 'commenter',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='commenter', to=orm['auth.User']),
                      keep_default=False)

        # Removing M2M table for field commenter on 'WallComment'
        db.delete_table('wall_wallcomment_commenter')
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'WallComment.wallpost'
        raise RuntimeError("Cannot reverse this migration. 'WallComment.wallpost' and its values cannot be restored.")
        # Deleting field 'WallComment.commenter'
        db.delete_column('wall_wallcomment', 'commenter_id')

        # Adding M2M table for field commenter on 'WallComment'
        db.create_table('wall_wallcomment_commenter', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('wallcomment', models.ForeignKey(orm['wall.wallcomment'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('wall_wallcomment_commenter', ['wallcomment_id', 'user_id'])
    ...
    models = {
        ...
        'wall.wallcomment': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'wallpost': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['wall.WallPost']", 'symmetrical': 'False'})
        },
        'wall.wallpost': {
