...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('profiles_profile', (
            ...
            ('countries', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['countries.Country'])),
    ...
    models = {
        ...
        'profiles.profile': {
            ...
            'countries': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['countries.Country']"}),
